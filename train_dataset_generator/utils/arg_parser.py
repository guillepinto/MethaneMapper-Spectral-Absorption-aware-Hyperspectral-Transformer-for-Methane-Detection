...
def get_train_gen_parser():
    """
    Defines and returns the argument parser for the training data generator utilities.
    This function DOES NOT parse the arguments, it only defines them.
    """
    parser = argparse.ArgumentParser(add_help=False) # Use add_help=False to avoid conflicts if combined
