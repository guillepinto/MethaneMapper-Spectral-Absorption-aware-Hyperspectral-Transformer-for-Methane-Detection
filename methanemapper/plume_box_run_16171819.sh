...
python hyper_main.py --dataset_file hyper_seg --pretrained True --output_dir ./exps/box_model --batch_size 1 --num_workers 2 \
    --train_img_folder data/train/training_data16171819 \
    --train_ann_file data/annotations_16171819/annotations_16171819.json \
    --val_img_folder data/train/training_data16171819 \
    --val_ann_file data/annotations_16171819/annotations_16171819.json \
